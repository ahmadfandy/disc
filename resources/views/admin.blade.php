            ...
            <div id="kt_header" style="" class="header align-items-stretch">
                ...
                <div class="d-flex align-items-stretch" id="kt_header_nav">
                    ...
                    <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                        <!--begin::Title-->
                        <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">CREATE ADMIN SCHOOL
                        </h1>
                        <!--end::Title-->
                    </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-header" id="kt_modal_add_user_header">
                                                    <!--begin::Modal title-->
                                                    <h2 class="fw-bolder">Add Admin School</h2>
                                                    <!--end::Modal title-->
                                                    <!--begin::Close-->
                                                ...
                                                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                    <!--begin::Form-->
                                                    <form id="kt_modal_add_user_form" class="form" action="{{route('admin.create') }}" method="post">
                                                        @csrf
                                                        <!--begin::Scroll-->
                                                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                                            ...
                                                            <div class="fv-row mb-7">
                                                                <!--begin::Label-->
                                                                <label class="required fw-bold fs-6 mb-2">PIC Name</label>
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" id="pic_name" name="pic_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Jhon Doe" value="" />
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--end::Input group-->
                                                            <!--begin::Input group-->
                                                            <div class="fv-row mb-7">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="email" id="admin_email" name="admin_email" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Jhon Doe" value="" />
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--end::Input group-->
                                                            <!--begin::Input group-->
                                                            <div class="fv-row mb-7">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="number" id="admin_telepon" name="admin_telepon" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="08123456789" value="" />
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--end::Input group-->
                                                            <!--begin::Input group-->
                                                            <div class="fv-row mb-7">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" id="admin_address" name="admin_address" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="08123456789" value="" />
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--end::Input group-->
                                                            <!--begin::Input group-->
                                                            <div class="fv-row mb-7">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" id="kodepos" name="kodepos" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="08123456789" value="" />
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--end::Input group-->
                                                            <!--begin::Input group-->
                                                            <div class="fv-row mb-7">
                                                                ...
                                                                <select id="school_select" name="school_select" class="form-select form-select-solid fw-bolder" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-user-table-filter="role" data-hide-search="true">
                                                                    ...
                                                                    @foreach ($value2 as $showdata2)
                                                                        <option value="{{$showdata2['idschool']}}">{{$showdata2['nama']}}</option>
                                                                    @endforeach
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                    ...
                                    <thead>
                                        ...
                                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="min-w-125px">PIC Name</th>
                                    ...
                                    <tbody class="text-gray-600 fw-bold">
                                        ...
                                        <tr>
                                            ...
                                            @foreach ($value2 as $showdata2)
                                            <?php if ($showdata['idsekolah'] == $showdata2['idschool']) { ?>
                                            <td>{{$showdata2["nama"]}}</td>
                                            <?php } ?>
                                            @endforeach
                                            <!--end::User=-->
                                            <!--begin::Role=-->
                                            ...
                                            <!--begin::Last login=-->
                                            <td>
                                                <div class="badge badge-light fw-bolder">{{$showdata["alamat"]}}</div>
                                            </td>
                                            <!--end::Last login=-->
                                            <!--begin::Two step=-->
